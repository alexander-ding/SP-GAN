...
def check_args(args):
    ...
    # --chekcpoint_dir + model_dir
    check_folder(os.path.join(args.checkpoint_dir, args.model_dir))
...
data_root_part = (
    root
    + "/lirh/pointcloud2/dataset/Generation/shapenetcore_partanno_segmentation_benchmark_v0/"
)
...
parser.add_argument("--bs", type=int, default=10, help="input batch size [default: 30]")
parser.add_argument(
    "--np",
    type=int,
    default=2048,
...
parser.add_argument(
    "--lr_g", type=float, default=0.0001, help="Initial learning rate [default: 0.0001]"
)
parser.add_argument(
    "--lr_d", type=float, default=0.0001, help="Initial learning rate [default: 0.0001]"
)
parser.add_argument(
    "--lr_decay_rate",
    type=float,
...
parser.add_argument(
    "--scale", type=float, default=1.0, help="Initial learning rate [default: 0.0001]"
)
parser.add_argument("--lr_decay_feq", type=int, default=40, help="use offset")
parser.add_argument(
    "--neg", type=float, default=0.01, help="Initial learning rate [default: 0.0001]"
)
parser.add_argument(
    "--neg2", type=float, default=0.01, help="Initial learning rate [default: 0.0001]"
)
...
parser.add_argument(
    "--max_epoch", type=int, default=6000, help="number of epochs to train for"
)
...
parser.add_argument(
    "--data_root", type=str, default=data_root_h5, help="data root [default: xxx]"
)
parser.add_argument(
    "--data_root_part",
    type=str,
    default=data_root_part,
    help="data root [default: xxx]",
)
...
parser.add_argument(
    "--model_dir", default="PDGN_v1", help="model dir [default: None, must input]"
)
parser.add_argument(
    "--checkpoint_dir",
    default="checkpoint",
...
parser.add_argument(
    "--snapshot", type=int, default=50, help="how many epochs to save model"
)
parser.add_argument("--choice", default="Chair", help="choice class")
parser.add_argument(
    "--network", default="PDGN_v1", help="which network model to be used"
)
...
parser.add_argument("--pretrain_model_z", default=None, help="use the pretrain model z")
parser.add_argument(
    "--softmax", type=str2bool, default=True, help="softmax for bilaterl interpolation"
)
parser.add_argument(
    "--dataset",
    default="shapenet",
    help="choice dataset [shapenet, modelnet10, modelnet40]",
)
...
parser.add_argument(
    "--bal_epoch", type=int, default=30, help="how many epochs to save model"
)
parser.add_argument("--norm", default="IN", help='"BN","IN","PN"')
parser.add_argument(
    "--d_iter", type=int, default=1, help="how many epochs to save model"
)
parser.add_argument(
    "--g_iter", type=int, default=1, help="how many epochs to save model"
)
...
parser.add_argument(
    "--epochs", type=int, default=2000, help="Integer value for epochs."
)
parser.add_argument("--lambdaGP", type=int, default=10, help="Lambda for GP term.")
parser.add_argument(
    "--D_iter", type=int, default=5, help="Number of iterations for discriminator."
)
parser.add_argument(
    "--support", type=int, default=10, help="Support value for TreeGCN loop term."
)
parser.add_argument(
    "--DEGREE",
    type=int,
...
parser.add_argument(
    "--D_FEAT",
    type=int,
    default=[3, 64, 128, 256, 512, 1024],
    nargs="+",
    help="Features for discriminator.",
)

parser.add_argument(
    "--lr_t", type=float, default=1e-4, help="Float value for learning rate."
)
parser.add_argument(
    "--lr_p", type=float, default=0.0001, help="Initial learning rate [default: 0.0001]"
)
