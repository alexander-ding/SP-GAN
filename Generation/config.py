...
parser.add_argument('--bs', type=int, default=10,
                    help='input batch size [default: 30]')
...
parser.add_argument('--nk', type=int, default=20,
                    help='number of the knn graph point')
...
parser.add_argument('--max_epoch', type=int, default=6000,
...
parser.add_argument('--data_root', type=str,
                    default=data_root_h5, help='data root [default: xxx]')
parser.add_argument('--data_root_part', type=str,
                    default=data_root_part, help='data root [default: xxx]')
...
parser.add_argument('--model_dir', default='PDGN_v1',
                    help='model dir [default: None, must input]')
...
parser.add_argument('--network', default='PDGN_v1',
                    help='which network model to be used')
parser.add_argument('--savename', default='PDGN_v1',
                    help='the generate data name')
parser.add_argument('--pretrain_model_G', default=None,
                    help='use the pretrain model G')
parser.add_argument('--pretrain_model_D', default=None,
                    help='use the pretrain model D')
parser.add_argument('--pretrain_model_z', default=None,
                    help='use the pretrain model z')
parser.add_argument('--softmax', type=str2bool, default=True,
                    help='softmax for bilaterl interpolation')
...
parser.add_argument('--bal_para', type=float,
                    default=0.15, help='value of noise')
parser.add_argument('--bal_epoch', type=int, default=30,
                    help='how many epochs to save model')
...
parser.add_argument('--ema_rate', type=float,
                    default=0.999, help='value of ema_rate')
parser.add_argument('--BN', action='store_true',
                    help='use BatchNorm in G and D')
parser.add_argument('--WS', action='store_true',
                    help='use WeightScale in G and D')
...
parser.add_argument('--FPD_path', type=str, default='./evaluation/pre_statistics_chair.npz',
